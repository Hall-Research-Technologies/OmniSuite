...
def list_state() -> Dict[str, Any]:
    with _state_lock:
        ...
        enc = [{
            ...
            "input_auto_switch": e.get("input_auto_switch"),
            "active_input": e.get("active_input"),
            "input_status": e.get("input_status") or [],
            "cable_present": e.get("cable_present"),
            "edid": e.get("edid"),
            "edid_options": e.get("edid_options") or [],
            "hdcp_support_version": e.get("hdcp_support_version"),
            "hdcp_supported_versions": e.get("hdcp_supported_versions") or [],
        ...
        dec = [{
            ...
            "sap_input_enabled": d.get("sap_input_enabled"),
            "input_session": d.get("input_session"),
            "input_session_options": d.get("input_session_options") or [],
            "hdcp_support_version": d.get("hdcp_support_version"),
            "hdcp_supported_versions": d.get("hdcp_supported_versions") or [],
            "video_input": d.get("video_input"),
            "audio_input": d.get("audio_input"),
            "video_input_options": d.get("video_input_options") or [],
            "audio_input_options": d.get("audio_input_options") or [],
            "stretch_crop_mode": d.get("stretch_crop_mode"),
            "stretch_crop_mode_options": d.get("stretch_crop_mode_options") or [],
            "resolution": d.get("resolution"),
            "resolution_options": d.get("resolution_options") or [],
            "framerate": d.get("framerate"),
            "framerate_options": d.get("framerate_options") or [],
            "fast_switching_enabled": d.get("fast_switching_enabled"),
            "fast_switching_timeout": d.get("fast_switching_timeout"),
            "fast_switching_colorspace": d.get("fast_switching_colorspace"),
            "fast_switching_colorspace_options": d.get("fast_switching_colorspace_options") or [],
            "video_wall_enabled": d.get("video_wall_enabled"),
            "video_wall_unit": d.get("video_wall_unit"),
            "video_wall_unit_options": d.get("video_wall_unit_options") or [],
            "video_wall_total_width": d.get("video_wall_total_width"),
            "video_wall_total_height": d.get("video_wall_total_height"),
            "video_wall_grid_width": d.get("video_wall_grid_width"),
            "video_wall_grid_height": d.get("video_wall_grid_height"),
            "video_wall_grid_x": d.get("video_wall_grid_x"),
            "video_wall_grid_y": d.get("video_wall_grid_y"),
            "video_wall_width": d.get("video_wall_width"),
            "video_wall_height": d.get("video_wall_height"),
            "video_wall_horizontal": d.get("video_wall_horizontal"),
            "video_wall_vertical": d.get("video_wall_vertical"),
            "video_wall_rotation": d.get("video_wall_rotation"),
            "video_wall_rotation_options": d.get("video_wall_rotation_options") or [],
            "video_wall_edge_mode": d.get("video_wall_edge_mode"),
            "video_wall_edge_mode_options": d.get("video_wall_edge_mode_options") or [],
            "video_wall_edge_top": d.get("video_wall_edge_top"),
            "video_wall_edge_bottom": d.get("video_wall_edge_bottom"),
            "video_wall_edge_left": d.get("video_wall_edge_left"),
            "video_wall_edge_right": d.get("video_wall_edge_right"),
        } for d in _decoders.values()]
